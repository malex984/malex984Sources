...
_OUT=`echo m4_default([$1], [$PACKAGE-config.h])` # new
### _OUT=`echo ifelse($1, , $PACKAGE-config.h, $1)` # old = my...

### _PKG=`echo m4_default([$2], [$PACKAGE])` # new
### _PKG=`echo ifelse($2, , $PACKAGE, $2)` # orig
_PKG=`echo $2` # my
