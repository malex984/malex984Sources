...
{ STATISTIC(n_Add); assume(r != NULL); assume(r->cfAdd!=NULL); return r->cfAdd(a, b, r); }


/// return the difference of 'a' and 'b', i.e., a-b
static inline number n_Sub(number a, number b, const coeffs r) 
{ STATISTIC(n_Sub); assume(r != NULL); assume(r->cfSub!=NULL); return r->cfSub(a, b, r); }
...
{ STATISTIC(n_DBTest); assume(r != NULL); assume(r->cfDBTest != NULL); return r->cfDBTest(n, filename, linenumber, r); }
#else
...
{ STATISTIC(n_DBTest);  return TRUE; }
#endif
...
{ STATISTIC(n_ChineseRemainderSym);
